...
RTresult displayFileFromDataPPM(const char* filename, RTsize width, RTsize height, RTformat buffer_format, void* buffer_data);
RTresult displayFilePNG(const char* filename, RTbuffer buffer);
RTresult displayFileFromDataPNG(const char* filename, RTsize width, RTsize height, RTformat buffer_format, void* buffer_data);
